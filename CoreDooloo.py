...
DB_NAME = "test.db"
VERSION = 'alfa 0.5.1'
DEFAULT_URL = 'https://www.youtube.com/channel/UCfxnN0xALQR6OtznIj35ypQ/videos'
...
class MainApp(QMainWindow, Ui_Form):
    ...
    def execute_this_fn(self, progress_callback):
        ...
        scroling_time = self.spinBox.value()
        scroll = scroling_time
        ...
        self.listWidget.addItem(f'Ожидание составит примерно: {prg_var / 10} сек')
        ...
        #добавить информацию к названию видео дата и время + перед скачивание добовлять папку с группой
        for obj in DB.value:
            url = obj[2]
            video_name = obj[1]
        ...
        return self.listWidget.addItem(f'Все видео были закачены в количестве {pars_prg}')
